...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_eks_cluster"></a> [eks\_cluster](#module\_eks\_cluster) | cloudposse/eks-cluster/aws | 4.12.0 |
| <a name="module_flowfuse_iam_role"></a> [flowfuse\_iam\_role](#module\_flowfuse\_iam\_role) | cloudposse/eks-iam-role/aws | 2.2.1 |
| <a name="module_node_groups"></a> [node\_groups](#module\_node\_groups) | cloudposse/eks-node-group/aws | 3.4.0 |
...
| <a name="input_eks_coredns_addon_version"></a> [eks\_coredns\_addon\_version](#input\_eks\_coredns\_addon\_version) | The version of the CoreDNS addon to install on the EKS cluster | `string` | `"v1.9.3-eksbuild.21"` | no |
| <a name="input_eks_kube_proxy_addon_version"></a> [eks\_kube\_proxy\_addon\_version](#input\_eks\_kube\_proxy\_addon\_version) | The version of the kube-proxy addon to install on the EKS cluster | `string` | `"v1.26.15-eksbuild.19"` | no |
...
| <a name="output_flowfuse_role_arn"></a> [flowfuse\_role\_arn](#output\_flowfuse\_role\_arn) | n/a |
